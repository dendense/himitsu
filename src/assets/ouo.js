    ...
    ? DOMAssistant.$("body a").each(function () {
        in_object(domains, DOMAssistant.$(this).href) &&
          ...
          ((url =
            ...
            ouo_token +
            "/?s=" +
            encodeURIComponent(DOMAssistant.$(this).href)),
...
var DOMAssistant = (function () {
  ...
  return {
      ...
      this.applyMethod.call(window, "$", this.$),
        ...
        (t.prototype.first = function () {
          return "undefined" != typeof this[0]
            ? DOMAssistant.addMethodsToElm(this[0])
            : null
        }),
    ...
    addMethods: function (t, e) {
      "undefined" == typeof this.allMethods[t] &&
        ((this.allMethods[t] = e), this.addHTMLArrayPrototype(t, e))
    },
    addMethodsToElm: function (t) {
      for (var e in this.allMethods)
        "undefined" != typeof this.allMethods[e] &&
          this.applyMethod.call(t, e, this.allMethods[e])
      return t
    },
    ...
    attach: function (t) {
      ...
      if ("undefined" == typeof e)
        for (var n in t)
          "init" !== n && "undefined" != typeof t[n] && this.addMethods(n, t[n])
    ...
    addHTMLArrayPrototype: function (e, n) {
      t.prototype[e] = function () {
        var e = new t()
        e.previousSet = this
        for (var s, a = 0, r = this.length; r > a; a++)
          (s = n.apply(this[a], arguments)),
            s && s.constructor === Array ? (e = o(e, s)) : e.push(s)
        return e
      }
    },
    clearHandlers: function () {
      for (
        var t, e, n = this.all || this.getElementsByTagName("*"), s = 0;
        (t = n[s++]);

      )
        if ((e = t.attributes))
          for (var a, r = 0, i = e.length; i > r; r++)
            (a = e[r].nodeName.toLowerCase()),
    ...
    $: function () {
      ...
      if (
        1 === arguments.length &&
        ("object" == typeof e || ("function" == typeof e && e.nodeName))
      )
        return DOMAssistant.$$(e)
      for (var n, s, i = new t(), u = 0; (n = arguments[u]); u++)
        if ("string" == typeof n)
          if (((n = n.replace(/^[^#]*(#)/, "$1")), l.id.test(n)))
            (s = DOMAssistant.$$(n.substr(1), !1)) && i.push(s)
          else {
            ...
            ;(i =
              ...
              a.doc === c
                ? a.elms
                : o(i, DOMAssistant.cssSelection.call(document, n))),
              (a = {
                rule: n,
                elms: i,
                doc: c,
    ...
    $$: function (t, e) {
      var n =
          "object" == typeof t || ("function" == typeof t && t.nodeName)
            ? t
    ...
    getSequence: function (t) {
      ...
      if (r[2]) (e = "odd" === r[2] ? 1 : 2), (a = 1 === e ? 1 : 0)
        ...
        for (
          n = r[6] ? parseInt(r[6], 10) : 1, e = r[7] ? parseInt(r[7], 10) : 0;
          1 > e;
        ...
        for (
          n = r[10] ? parseInt(r[10], 10) : 1, e = s = parseInt(r[11], 10);
          e > n;
    ...
    cssByDOM: function (a) {
      ...
      function p(t, e) {
        switch (
          ((t = t ? t.replace(l.quoted, "$1").replace(/\./g, "\\.") : null), e)
        ) {
          case "^":
            return "^" + t
          case "$":
      ...
      function v(t, e) {
        return (
          (t = t || "*"),
          (e = e || document),
          e === document || e.lastModified
            ? s[t] || (s[t] = g(t, document))
            : g(t, e)
        )
      }
      function m(t, e, n) {
        ...
        var i,
          ...
          M = {
            ...
            contains: function () {
              return (
                (C.innerText || C.textContent || "").indexOf(
                  n.replace(l.quoted, "$1")
                ) > -1
              )
            },
            other: function () {
        ...
        switch (A) {
          ...
          case "target":
            ...
            break
          case "not":
            if ((o = l.pseudo.exec(n)))
              c = f(t, m(t, o[1] ? o[1].toLowerCase() : null, o[3] || null))
            else {
      ...
      for (var k = 0; (A = E[k]); k++)
        if (!k || !u(E.slice(0, k), A)) {
          ...
          for (var R, P = 0; (R = b[P]); P++) {
            if (
              ((N = []),
              P > 0 && l.relation.test(R) && (O = l.relation.exec(R)))
            ) {
              var I = null,
                B = b[P + 1]
              ;(w = l.tag.exec(B))
                ? ((w = w[1]), (x = new RegExp("(^|\\s)" + w + "(\\s|$)", "i")))
                : l.id.test(B) && (I = DOMAssistant.$(B) || null)
              for (var J, _ = 0; (J = F[_]); _++)
                switch (O[0]) {
                  case ">":
                    for (var V, W = I || v(w, J), K = 0; (V = W[K]); K++)
                      V.parentNode === J && (N[N.length] = V)
                    break
                  case "+":
                    for (; (J = J.nextSibling) && 1 !== J.nodeType; );
                    J &&
                      ((I && I[0] === J) ||
                        (!I && (!w || x.test(J.nodeName)))) &&
                      (N[N.length] = J)
                    break
                  case "~":
                    for (; (J = J.nextSibling) && !J.added; )
                      ((I && I[0] === J) ||
                        (!I && (!w || x.test(J.nodeName)))) &&
                        ((J.added = !0), (N[N.length] = J))
                }
              if (((F = N), r(), (R = b[++P]), /^\w+$/.test(R) || l.id.test(R)))
                continue
              F.skipTag = !0
            }
            ...
            if (G.id) {
              ...
              if (0 !== P || N.length || 1 !== F.length) {
                for (var Q, Y, te = 0, ee = F.length; ee > te; te++) {
                  Q = v(G.tag, F[te])
                  for (var ne = 0; (Y = Q[ne]); ne++)
                    Y.added || ((Y.added = !0), (N[N.length] = Y))
                }
                ;(F = N), r()
            ...
            if (((F.skipTag = !1), G.allClasses)) {
              for (
                var se = 0, ae = [], re = G.allClasses.split(".").slice(1);
                (D = F[se++]);
            ...
            if (G.allAttr) {
              for (
                var ce,
                  ...
                  he = [],
                  pe = [],
                  ge = G.allAttr.match(/\[[^\]]+\]/g),
                  ve = 0,
                  me = ge.length;
                me > ve;
                ve++
              )
                (l.attribs.lastIndex = 0),
                  (ce = l.attribs.exec(ge[ve])),
                  (de = p(ce[3], ce[2] || null)),
                  (he[ve] = [de ? new RegExp(de) : null, ce[1]])
              for (; (D = N[fe++]); ) {
                for (var Me = 0, ye = he.length; ye > Me; Me++) {
                  ...
                  if (
                    !(
                      (!be && Oe === !0) ||
                      ((be || (Oe && "string" == typeof Oe && Oe.length)) &&
                        (!be || be.test(Oe)))
                    )
                  ) {
                    Ae = !1
            ...
            if (G.allPseudos) {
              for (
                var we = G.allPseudos.match(l.pseudos), xe = 0, De = we.length;
                De > xe;
                xe++
              ) {
            ...
            if (!M || !u(g.slice(0, M), o)) {
              ...
              for (var y = 0, A = c.length; A > y; y++) {
                if (
                  ...
                  d +=
                    y > 0 && l.relation.test(c[y - 1])
                      ? h.tag
                      : "/descendant::" + h.tag
                if (
                  (h.id && (d += '[@id = "' + h.id.replace(/^#/, "") + '"]'),
                  h.allClasses &&
                    (d += h.allClasses.replace(
                      l.classes,
                      '[contains(concat(" ", @class, " "), " $1 ")]'
                    )),
                  ...
                  for (
                    var O = h.allPseudos.match(l.pseudos), w = 0, x = O.length;
                    x > w;
                    w++
                  ) {
                    l.pseudos.lastIndex = 0
              ...
              for (
                var S, H = document.evaluate(d, this, a, 0, null);
                (S = H.iterateNext());
    ...
    cssSelection: function (e) {
      if (
        ((DOMAssistant.cssSelection = document.evaluate
          ? DOMAssistant.cssByXpath
          : DOMAssistant.cssByDOM),
        document.querySelectorAll)
      ) {
...
DOMAssistant.initCore(),
  (DOMAssistant.AJAX = (function () {
    var globalXMLHttp = null,
      ...
      createAjaxObj = function (t, e, n, s) {
        var a = null
        return (
          /POST/i.test(e) && ((t = t.split("?")), (a = t[1]), (t = t[0])),
          {
            url: t,
            method: e,
            callback: n,
    ...
    return {
      ...
      ajax: function (t) {
        if (
          ...
          /\?/.test(t.url) &&
          t.method &&
          /POST/i.test(t.method)
        ) {
          var e = t.url.split("?")
          ;(t.url = e[0]),
            (t.params =
              e[1] + (e[1].length > 0 && t.params ? "&" + t.params : ""))
        }
      ...
      load: function (t, e) {
        DOMAssistant.AJAX.get.call(
          this,
          t,
          DOMAssistant.AJAX.replaceWithAJAXContent,
          e
        )
      },
          ...
          XMLHttp &&
            ...
            (function (elm) {
              ...
              for (var i in headers)
                "string" == typeof i && XMLHttp.setRequestHeader(i, headers[i])
                ...
                (XMLHttp.onreadystatechange = function () {
                  try {
                    ...
                    ;(globalXMLHttp = XMLHttp = null),
                      "function" == typeof ex && (ex.call(elm, e), (ex = null))
                  }
                }),
                XMLHttp.send(params),
                timeout &&
      ...
      replaceWithAJAXContent: function (t, e) {
        e
          ? (this.innerHTML += t)
          : (DOMAssistant.clearHandlers.apply(this), (this.innerHTML = t))
      },
      getReadyState: function () {
        return globalXMLHttp && "undefined" != typeof globalXMLHttp.readyState
          ? globalXMLHttp.readyState
          : readyState
      },
      getStatus: function () {
        return status
  ...
  (DOMAssistant.CSS = (function () {
    return {
      ...
      setStyle: function (t, e) {
        if (
          (this.filters &&
            ("string" == typeof t ? /opacity/i.test(t) : t.opacity) &&
            (this.style.filter =
              "alpha(opacity=" + 100 * (e || t.opacity || 1) + ")"),
          "undefined" != typeof this.style.cssText)
        ) {
      ...
      getStyle: function (t) {
        ...
        if (
          ...
          if (this.filters && /^opacity$/.test(t)) {
            var n =
              this.filters["DXImageTransform.Microsoft.Alpha"] ||
              this.filters.alpha ||
              {}
            e = (n.opacity || 100) / 100
          } else
            (t = t
              .replace(/^float$/, "styleFloat")
          ...
          "auto" === e &&
            /^(width|height)$/.test(t) &&
            "none" !== this.currentStyle.display &&
            (e =
              this["offset" + t.charAt(0).toUpperCase() + t.substr(1)] + "px")
        }
        return e
      },
    }
  ...
  (DOMAssistant.Content = (function () {
    ...
    return {
      ...
      create: function (e, n, s, a) {
        ...
        return (
          n && (r = r.setAttributes(n)),
          "undefined" != typeof a && r.addContent(a),
          s && DOMAssistant.Content.addContent.call(this, r),
          r
        )
      },
      ...
      addContent: function (t) {
        ...
        return (
          "string" === e || "number" === e
            ? (this.innerHTML += t)
            : ("object" === e || ("function" === e && t.nodeName)) &&
              this.appendChild(t),
          this
        )
      },
      replaceContent: function (t) {
        return (
          ...
          (this.innerHTML = ""),
          DOMAssistant.Content.addContent.call(this, t)
        )
      },
        ...
        if ("string" === s || "number" === s) {
          for (
            var a = this.parentNode,
              r = t(a).create("div", null, !1, e),
              i = r.childNodes.length - 1;
            i >= 0;
            i--
          )
            a.insertBefore(r.childNodes[i], this.nextSibling)
          ;(e = this.nextSibling), a.removeChild(this)
        } else
          ("object" === s || ("function" === s && e.nodeName)) &&
  ...
  (DOMAssistant.Events = (function () {
    ...
    return {
      ...
      addEvent: function (e, n) {
        if (/^DOM/.test(e))
          this.addEventListener && this.addEventListener(e, n, !1)
        else if (
          (this.uniqueHandlerId || (this.uniqueHandlerId = t++),
          !n.attachedElements || !n.attachedElements[e + this.uniqueHandlerId])
        ) {
          ...
          this.events[e].push(n),
            ...
            "object" == typeof this.window &&
              (this.window["on" + e] = DOMAssistant.Events.handleEvent),
      ...
      handleEvent: function (t) {
        for (
          var e = t || event, n = e.target || e.srcElement || document;
          1 !== n.nodeType && n.parentNode;
        ...
        if ((s = r.length)) {
          for (var i = 0; s > i; i++)
            "function" == typeof r[i] && (a = r[i].call(this, e))
          return a
        }
      },
      removeEvent: function (t, e) {
        if (this.events && this.events[t])
          for (var n, s = this.events[t], a = s.length - 1; a >= 0; a--)
            (n = e || s[a]),
              s[a] === n &&
                (delete s[a],
                s.splice(a, 1),
                n.attachedElements &&
                  (n.attachedElements[t + this.uniqueHandlerId] = null))
  ...
  (DOMAssistant.DOMLoad = (function () {
    ...
    return (
      ...
      {
        DOMReady: function () {
          for (var e, a = 0, i = arguments.length; i > a; a++)
            (e = arguments[a]),
              e.DOMReady ||
                s[e] ||
                ("string" == typeof e && ((s[e] = !0), (e = new Function(e))),
                (e.DOMReady = !0),
                n.push(e))
          t && r()
        },
